...
void CUDACreateFromSlices(string anatomicalFolder, string segmentedFolder, vector<SegmentData>& segmentationTable, vector<uchar>& segmentationTransfer, int depthMulptiplier, int eps, uint3& dim, vector<Voxel>& voxels);